...
function GuideMenu:RefreshUI()
	...
	if self.selectedguide then
		...
		frame.GuideImage:SetTexture(CGV.DIR.."/Viewer/Skins/Stealth/cgeso-firesong.dds")
		frame.GuideData:SetText("Imperial City, Craglorn, Southern Elsweyr, Western Skyrim, The Reach, and Blackwood, The Deadlands, High Isle, and Firesong guides authored by |cffaa00snichols7778|r\nSummerset, Murkmire and Elsweyr guides authored by |cffaa00Hydra9268|r\nAdditional support by |cffaa00Sharlikran|r, |cffaa00Krandor1|r\n|c999999Original guide and Addon created by Zygor Guides|r")
...
function Settings:CreateDefaultPopup()
	...
	local popup = CHAIN(CGV.Popup:New("Zygor_Settings_Reset_Default_Popup"))
