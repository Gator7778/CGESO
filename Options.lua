  ...
  do
    ...
    AddOption(nil,{
        ...
        func = function()
          ...
          SavedVars.ResetProfilePopup = SavedVars.ResetProfilePopup or CGV.Popup:New("Zygor_Reset_Profile_Popup")
          ...
          me:RegisterOnOpenCallback(function(me)
              ...
              for i,name in ipairs(profiles) do if name ~= SavedVars.raw.curprofile then
                me:AddItem(name,name,function(item,value)
                    ...
                    SavedVars.DeleteProfilePopup = SavedVars.DeleteProfilePopup or CGV.Popup:New("Zygor_Delete_Profile_Popup")
            ...
            me:RegisterOnOpenCallback(function(me)
                ...
                for i,name in ipairs(profiles) do if CGV.Utils.GetPlayerName() ~= name then
                  me:AddItem(name,name,function(item,value)
                      ...
                      SavedVars.CopyProfilePopup = SavedVars.CopyProfilePopup or CGV.Popup:New("Zygor_Copy_Profile_Popup")
